<template>
        ...
        <template v-slot:form="{ close, update}">
          <q-card style="width: 700px; max-width: 90vw;">
            <q-toolbar class="q-pa-md">
              ...
              />
              <q-toolbar-title>
                {{ menu.id ? 'Editar' : 'Agregar' }} Tipo - Proyecto
              </q-toolbar-title>
              <q-space />
              <q-btn
                flat
  ...
  import Menu from 'components/Formularios/TipoPF.vue'
