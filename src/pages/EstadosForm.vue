<template>
  ...
  import Menu from 'components/Formularios/Estados.vue'
  ...
  export default {
    ...
    setup () {
      ...
      const guardar = async (update, close) => {
        const mensaje = !menu.value.id ? 'Estado creado de manera exitosa.' : 'Estado actualizado de manera exitosa.'
        if (menu.value.id) {
