<template>
  <q-page>
    <Titulo titulo="Co - Ejecutores" icono="build_circle"></Titulo>
    <CrudTable
      :filters="filters"
      :columns="columns"
      :url="url"
      ...
      <template v-slot:form="{ close, update }">
        <q-card style="width: 700px; max-width: 90vw">
          <q-toolbar class="q-pa-md">
            ...
            <q-toolbar-title>
              {{ menu.id ? "Editar" : "Agregar" }} Co - Ejecutor
            </q-toolbar-title>
            <q-space />
...
import Menu from "components/Formularios/CoEjecF.vue";
  ...
  setup() {
    ...
    const guardar = async (update, close) => {
      const mensaje = !menu.value.id
        ? "Departamento creado de manera exitosa."
        : "Departamento actualizado de manera exitosa.";
      if (menu.value.id) {
