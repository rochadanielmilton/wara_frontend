<template>
    <q-page>
      <Titulo
        titulo="Contraparte Responsable"
        icono="badge"
      ></Titulo>
      <CrudTable
        :filters="filters"
        ...
        <template v-slot:form="{ close, update}">
          <q-card style="width: 700px; max-width: 90vw;">
            <q-toolbar class="q-pa-md">
              ...
              />
              <q-toolbar-title>
                {{ menu.id ? 'Editar' : 'Agregar' }} Responsable
              </q-toolbar-title>
              <q-space />
              <q-btn
                flat
  ...
  import Menu from 'components/Formularios/ContraparteF.vue'
  ...
  export default {
    ...
    setup () {
      ...
      const url = ref('/responsables-contraparte/')
      const menu = ref({
        grupo: null,
        nombre: null,
        descripcion: null,
