...
"
  ...
  import Menu from 'components/Formularios/Sectores.vue'
  ...
  export default {
    ...
    setup () {
      ...
      const guardar = async (update, close) => {
        const mensaje = !menu.value.id ? 'Sector creado de manera exitosa.' : 'Sector actualizado de manera exitosa.'
        if (menu.value.id) {
