<template>
  <div class="green-background">
    <q-form @submit.prevent="$emit('guardar')">
      <h6 style="text-align: center; margin-top: 0%">RESIDUOS</h6>
        ...
        <q-stepper v-model="currentStep" animated>
              ...
              <div class="q-gutter-md row">
                <!-- <div class="col" >
                  <q-select
                    ...
                    v-model="valoresModel.preinversion"
                    :options="preinversion"
                    option-value="id"
                    option-label="codigo_convenio"
                    @update:model-value="change_preinversion"
                  />
                </div> -->
                <div class="col" v-if="!isMigrated">
                  <q-input
                    square
                    label="Codigo sisin residuos"
              ...
              <div class="q-gutter-md row">
                <!-- <div class="col">
                  <q-select
                    ...
                    v-model="valoresModel.empresa_constructora_name"
                    square
                    class="col-xs-12 col-md-3"
              ...
              <div class="q-gutter-md row">
                <div class="col">
                  <q-input
                    ...
                    v-model="valoresModel.numero_familias_beneficiadas"
                    mask="###,###,###,###,###,###,###,###,###,###,###,###,###"
                    reverse-fill-mask
                    unmasked-value
                  />
                ...
                <div class="col">
                  <q-input
                    ...
                    v-model="valoresModel.numero_familias_indirectas"
                    mask="###,###,###,###,###,###,###,###,###,###,###,###,###"
                    reverse-fill-mask
                    unmasked-value
                  />
              ...
              <div class="q-gutter-md row">
                <div class="col">
                  <q-input
                    ...
                    v-model="valoresModel.beneficiados_varones"
                    mask="###,###,###,###,###,###,###,###,###,###,###,###,###"
                    reverse-fill-mask
                    unmasked-value
                  />
                ...
                <div class="col">
                  <q-input
                    ...
                    v-model="valoresModel.beneficiados_mujeres"
                    mask="###,###,###,###,###,###,###,###,###,###,###,###,###"
                    reverse-fill-mask
                    unmasked-value
                  />
          ...
          >
            <q-form ref="form4" @submit.prevent="$emit('guardar')">
              ...
              <!-- <q-pdfviewer
                  v-model="valoresModel.documento_creacion"
                  :src="valoresModel.documento_creacion"
                  type="pdfjs"
                /> -->
              ...
              <!-- <embed :src="valoresModel.documento_creacion" type="application/pdf" width="100%" height="600px" />
...
export default {
  ...
  setup(props) {
    ...
    const empresa_constructora = ref("");
    ...
    onMounted(async () => {
      try {
        fetchOptions();
        console.log("al abrir residuos", valoresModel.value);
    ...
    const change_preinversion = () => {
      //activar la lista siguiente...
      valoresModel.value.preinversion = valoresModel.value.preinversion.id;
      console.log(valores.value.preinversion);
    };
...
.green-background {
  background-color: #f1f4bc; /* color verde claro */
