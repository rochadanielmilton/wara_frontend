<template>
    <q-form class="row q-col-gutter-md" @submit="$emit('guardar')">
      <q-input square class="col-xs-12 col-md-12" label="Ministerio" v-model="valoresModel.nombre"
    ...
    />
    <!--  <q-input square class="col-xs-12 col-md-6" label="Ruta" v-model="valoresModel.ruta" :rules="valoresRules.ruta" />
