<template>
    <q-form class="row q-col-gutter-md" @submit="$emit('guardar')">
      <q-input filled class="col-xs-12 col-md-12" label="Ejecutor" v-model="valoresModel.nombre"
        :rules="[  val => val.length <= 30 || 'Como maximo solo debe tener  30 carácteres.',val => !!val || 'Este campo es requerido']" required />
      <q-toggle
