    ...
    <div>
      ...
      <q-dialog v-model="showPdfViewer" persistent>
        <q-card style="width: 80vw; height: 80vh">
          <q-card-section>
            <div class="text-h6">PDF Viewer</div>
          </q-card-section>
          ...
          >
            <q-form ref="form1" @submit.prevent="nextStep" greedy>
              ...
              <div class="q-gutter-md row">
                ...
                <!-- {{valores.sector_clasificador_name}} -->
                ...
                <div class="col">
                  <q-col cols="3" md="3">
                    <q-select
                      ...
                      v-model="valores.viceministerio_name"
              ...
              <div class="q-gutter-md row">
                <!-- <div class="col">
                  <q-select
                    ...
                    v-model="valores.empresa_constructora_name"
                    square
            ...
            <q-form ref="form2" @submit.prevent="nextStep">
              ...
              <div class="q-gutter-md row">
                ...
                <div class="col">
                  <q-input
                    ...
                    square
                    label="TONELADAS RESIDUOS DISUPUESTO AÑO"
                    v-model="valores.toneladas_residuos_dispuestos_anio"
                    mask="###,###,###,###,###,###,###,###,###,###,###,###,###"
                    reverse-fill-mask
                    unmasked-value
                  />
                ...
                <div class="col">
                  <q-input
                    ...
                    square
                    label="TONELADAS RESIDUOS APROVECHAMIENTO AÑO"
                    v-model="valores.toneladas_residuos_aprovechamiento_anio"
                    mask="###,###,###,###,###,###,###,###,###,###,###,###,###"
                    reverse-fill-mask
                    unmasked-value
                  />
              ...
              <q-col cols="12" md="12">
                <q-input
                  ...
                  :rules="[
                    (val) =>
                      (val && val.length <= 1500) || 'Máximo 1500 caracteres',
                  ]"
                />
              </q-col>
              <br />
...
export default {
  ...
  setup(props) {
    ...
    const url = ref("/residuos/proyectos/" + props.proyecto.id + "/");
    const file = ref(null);
    ...
    const openPdf = (programaId) => {
      console.log("alsjdfñlajsdlñf");
      showPdfViewer.value = true;
      const pdfLink = valores.value.documento_creacion;
      pdfff.value = `https://docs.google.com/viewerng/viewer?url=${pdfLink}&embedded=true`;
    };
    ...
    onMounted(async () => {
      try {
        ...
        const fechas = ["fecha_fin_cif", "fecha_inicio_cif"];
        ...
        console.log("valores residuo", valores.value);
        console.log("observaciones:", typeof valores.value.observaciones);
    ...
    const guardar = async () => {
      try {
        console.log("para guardar (RESIDUOS)****", valores.value);
        valores.value.lugar = 1;
        valores.value.organizacion = 1;
        delete valores.value.empresa_constructora;
        if (
        ...
        campos.forEach((campo) => {
          if (
            valores.value[campo] == null ||
            typeof valores.value[campo] == "string"
          ) {
            delete valores.value[campo];
          }
        });

        // valores.value.empresa_constructora =
        //   valores.value.empresa_constructora_name.id;
        ...
        if (valores.value.id) {
          ...
          console.log("POST");
          await _http.post("/residuos/proyectos/", formData, config);
        }
      } catch (error) {
        console.log(error);
      }
